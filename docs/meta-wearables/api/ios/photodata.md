<!-- source: https://wearables.developer.meta.com/docs/reference/ios_swift/dat/0.6/mwdatcamera_photodata | scraped: 2026-04-28 -->
...
`format: [PhotoCaptureFormat](/docs/reference/ios_swift/dat/0.6/mwdatcamera_photocaptureformat)`
