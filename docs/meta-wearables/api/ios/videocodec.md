<!-- source: https://wearables.developer.meta.com/docs/reference/ios_swift/dat/0.6/mwdatcamera_videocodec | scraped: 2026-04-28 -->
...
Raw decompressed video frames (420v YUV pixel buffers). - Note: Video frames are only delivered while the app is in the foreground. When the app enters background, frame delivery stops. Use [hvc1](/docs/reference/ios_swift/dat/0.6/mwdatcamera_videocodec#hvc1) if you need to receive frames while backgrounded.
