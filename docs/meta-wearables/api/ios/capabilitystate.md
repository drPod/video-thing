<!-- source: https://wearables.developer.meta.com/docs/reference/ios_swift/dat/0.6/mwdatcore_capabilitystate | scraped: 2026-04-28 -->
...
Represents the state of a capability attached to a [DeviceSession](/docs/reference/ios_swift/dat/0.6/mwdatcore_devicesession).
