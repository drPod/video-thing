<!-- source: https://wearables.developer.meta.com/docs/reference/ios_swift/dat/0.6/mwdatcore_device | scraped: 2026-04-28 -->
...
**identifier** : [DeviceIdentifier](/docs/reference/ios_swift/dat/0.6/mwdatcore_deviceidentifier)

The unique identifier for this device.

**linkState** : [LinkState](/docs/reference/ios_swift/dat/0.6/mwdatcore_linkstate)
...
**addCompatibilityListener** ( listener )
...
`_ listener: @escaping @Sendable ([Compatibility](/docs/reference/ios_swift/dat/0.6/mwdatcore_compatibility)) -> Void`  The callback to execute when the compatibility changes.

Returns

`[AnyListenerToken](/docs/reference/ios_swift/dat/0.6/mwdatcore_anylistenertoken)`  A token that can be used to cancel the listener.

**addLinkStateListener** ( listener )
...
`_ listener: @escaping @Sendable ([LinkState](/docs/reference/ios_swift/dat/0.6/mwdatcore_linkstate)) -> Void`  The callback to execute when the link state changes.
...
`[Compatibility](/docs/reference/ios_swift/dat/0.6/mwdatcore_compatibility)`
...
`[DeviceType](/docs/reference/ios_swift/dat/0.6/mwdatcore_devicetype)`  The device type identifier.
