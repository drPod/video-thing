<!-- source: https://wearables.developer.meta.com/docs/reference/ios_swift/dat/0.6/mwdatmockdevice_mockdisplaylessglassesservices | scraped: 2026-04-28 -->
...
# MockDisplaylessGlassesServices Protocol
...
protocol MockDisplaylessGlassesServices: Sendable

## Properties

**camera** : [MockCameraKit](/docs/reference/ios_swift/dat/0.6/mwdatmockdevice_mockcamerakit)
