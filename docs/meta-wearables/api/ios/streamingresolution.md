<!-- source: https://wearables.developer.meta.com/docs/reference/ios_swift/dat/0.6/mwdatcamera_streamingresolution | scraped: 2026-04-28 -->
...
Extends Sendable, CaseIterable

Valid Live Streaming resolutions. We are using 9:16 aspect ratio.

## Signature

enum StreamingResolution: Sendable, CaseIterable
...
**videoFrameSize** : [VideoFrameSize](/docs/reference/ios_swift/dat/0.6/mwdatcamera_videoframesize)
