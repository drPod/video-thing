<!-- source: https://wearables.developer.meta.com/docs/reference/ios_swift/dat/0.6/mwdatcore_announcer | scraped: 2026-04-28 -->
...
`_ listener: @Sendable @escaping (T) -> Void`  The callback to execute when an event occurs.
